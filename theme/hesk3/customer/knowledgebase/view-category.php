...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo HESK_PATH; ?>img/icon/icon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo HESK_PATH; ?>img/icon/icon-16x16.png" />
    ...
    <link rel="shortcut icon" href="<?php echo HESK_PATH; ?>img/icon/icon.ico" />
